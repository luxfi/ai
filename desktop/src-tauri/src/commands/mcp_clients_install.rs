...
use tauri::AppHandle;
use crate::local_zoo_node::process_handlers::process_utils::kill_process_by_name;
...
6.  Save the file.
7.  Start Claude. Your Zoo server should now be available.
...
4.  Save the file.
5.  **Restart Cursor**. Your Zoo server should now be available.
...
4.  Save the file.
5.  **Restart Cursor**. Your Zoo server should now be available via SSE.
